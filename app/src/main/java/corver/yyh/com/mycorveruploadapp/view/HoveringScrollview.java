package corver.yyh.com.mycorveruploadapp.view;
...
public class HoveringScrollview extends ScrollView {
	...
	private OnCustomserScrollListener onScrollListener;
	/**
	 ...
	 */
	public void setOnScrollListener(OnCustomserScrollListener onScrollListener) {
	 ...
	 * 滚动的回调接口
	 */
	public interface OnCustomserScrollListener {
		/**
